...
package org.nightlabs.jfire.base.login.rcp.ui.action;
...
import org.nightlabs.jfire.base.login.rcp.ui.JFireRCPLoginPlugin;
...
extends LSDWorkbenchWindowActionDelegate
{
	...
	public void init(IWorkbenchWindow window) {
		...
		if (loginIcon_menu == null)
			loginIcon_menu = SharedImages.getSharedImageDescriptor(JFireRCPLoginPlugin.getDefault(), LoginAction.class, "Login", ImageDimension._16x16, ImageFormat.png); //$NON-NLS-1$

		if (logoutIcon_menu == null)
			logoutIcon_menu = SharedImages.getSharedImageDescriptor(JFireRCPLoginPlugin.getDefault(), LoginAction.class, "Logout", ImageDimension._16x16, ImageFormat.png); //$NON-NLS-1$

		if (loginIcon_toolbar == null)
			loginIcon_toolbar = SharedImages.getSharedImageDescriptor(JFireRCPLoginPlugin.getDefault(), LoginAction.class, "Login", ImageDimension._24x24, ImageFormat.png); //$NON-NLS-1$

		if (logoutIcon_toolbar == null)
			logoutIcon_toolbar = SharedImages.getSharedImageDescriptor(JFireRCPLoginPlugin.getDefault(), LoginAction.class, "Logout", ImageDimension._24x24, ImageFormat.png); //$NON-NLS-1$
