...
implements INewWizard
{
	...
	private String personPagesTitle;
	...
	public CreatePersonWizard(String windowTitle) {
		this(windowTitle, null);
	}
	
	public CreatePersonWizard(String windowTitle, String personPagesTitle) {
		setWindowTitle(windowTitle != null ? windowTitle : "");
		this.personPagesTitle = personPagesTitle;
	}
	...
	public void addPages() {
		...
		newPersonEditorWizardHop = new PersonEditorWizardHop(personPagesTitle);
		newPersonEditorWizardHop.initialise(newPerson);

		if (personPagesTitle != null)
			newPersonEditorWizardHop.getEntryPage().setTitle(personPagesTitle);
