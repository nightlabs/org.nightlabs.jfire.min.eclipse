...
public abstract class AbstractDataBlockEditorFactory implements DataBlockEditorFactory {
	...
	public StructBlockID getProviderStructBlockID() {
		if (structBlockID == null) {
			throw new IllegalStateException("The StructBlockID from could not be read for a registration of " + this.getClass().getName()  + "in " + bundleName);
		}
	...
	public void setInitializationData(IConfigurationElement config, String propertyName, Object data) throws CoreException {
		...
		String structBlockIDStr = config.getAttribute("structBlockID");
		if (structBlockIDStr != null && !"".equals(structBlockIDStr)) {
