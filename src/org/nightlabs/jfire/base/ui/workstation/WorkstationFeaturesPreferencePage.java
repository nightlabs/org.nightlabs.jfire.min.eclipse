...
//				configModule.getFeatures().values())
	...
	protected List<WorkstationFeature> getAvailableFeatures() {
		...
		result.add(new WorkstationFeature(cfMod, "org.nightlabs.jfire.base.ui", "1.0.0")); //$NON-NLS-1$ //$NON-NLS-2$
		result.add(new WorkstationFeature(cfMod, "org.nightlabs.jfire.base.admin.ui", "1.0.0")); //$NON-NLS-1$ //$NON-NLS-2$
		return result;
	}
