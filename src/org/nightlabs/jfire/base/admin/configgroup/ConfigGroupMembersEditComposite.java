...
import org.nightlabs.jfire.base.admin.rolegroup.RoleGroupContainer;
import org.nightlabs.jfire.base.config.ConfigSetupRegistry;
...
//		availConfigsTitle.setText("Users available\n(and in other groups)");
		...
		buttonAssign.setText(Messages.getString("org.nightlabs.jfire.base.admin.configgroup.ConfigGroupMembersEditComposite.buttonAssign.text")); //$NON-NLS-1$
		...
		buttonRemove.setText(Messages.getString("org.nightlabs.jfire.base.admin.configgroup.ConfigGroupMembersEditComposite.buttonRemove.text")); //$NON-NLS-1$
