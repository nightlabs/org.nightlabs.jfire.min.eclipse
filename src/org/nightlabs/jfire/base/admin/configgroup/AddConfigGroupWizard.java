...
public class AddConfigGroupWizard extends DynamicPathWizard {
	...
	public static class EntryPage extends DynamicPathWizardPage {
		...
		public Control createPageContents(Composite parent) {
			...
			groupIDText = new LabeledText(wrapper, Messages.getString("org.nightlabs.jfire.base.admin.configgroup.AddConfigGroupWizard.groupID.caption")); //$NON-NLS-1$
			...
			groupNameText = new LabeledText(wrapper, Messages.getString("org.nightlabs.jfire.base.admin.configgroup.AddConfigGroupWizard.groupName.caption")); //$NON-NLS-1$
	...
	public IDynamicPathWizardPage createWizardEntryPage() {
		entryPage = new EntryPage(this, Messages.getString("org.nightlabs.jfire.base.admin.configgroup.AddConfigGroupWizard.entryPage.title"));  //$NON-NLS-1$
		return entryPage;
	}
