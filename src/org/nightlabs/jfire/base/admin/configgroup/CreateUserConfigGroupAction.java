	...
	public void run(IAction action) 
	{
  	DynamicPathWizardDialog wzd = new DynamicPathWizardDialog(
				...
				new CreateConfigGroupWizard(
						...
						Messages.getString("org.nightlabs.jfire.base.admin.configgroup.CreateUserConfigGroupAction.wizardTitle"), //$NON-NLS-1$
						Messages.getString("org.nightlabs.jfire.base.admin.configgroup.CreateUserConfigGroupAction.pageTitle") //$NON-NLS-1$
				)
			);
    wzd.open();
	}
