...
public class CreateConfigGroupPage extends DynamicPathWizardPage implements FormularChangeListener
{
	...
	public Control createPageContents(Composite parent) 
	{
		...
		configGroupName = f.addTextInput(Messages.getString("org.nightlabs.jfire.base.admin.configgroup.CreateConfigGroupPage.configGroupName.labelText"), null); //$NON-NLS-1$
		configGroupKey = f.addTextInput(Messages.getString("org.nightlabs.jfire.base.admin.configgroup.CreateConfigGroupPage.configGroupKey.labelText"), null); //$NON-NLS-1$
	...
	protected void verifyInput() 
	{
		if("".equals(getConfigGroupName())) //$NON-NLS-1$
			updateStatus(Messages.getString("org.nightlabs.jfire.base.admin.configgroup.CreateConfigGroupPage.errorConfigGroupNameMissing")); //$NON-NLS-1$
		else
			updateStatus(null);
	}
