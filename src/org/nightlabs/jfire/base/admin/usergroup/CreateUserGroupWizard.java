 ...
 *
 */
public class CreateUserGroupWizard extends Wizard
{
	...
	throws LoginException, NamingException, RemoteException, CreateException
	{
		...
		setWindowTitle(Messages.getString("org.nightlabs.jfire.base.admin.usergroup.CreateUserGroupWizard.windowTitle")); //$NON-NLS-1$
	}
	...
	public boolean performFinish()
	{
		try {
			...
			newGroup.setName(cugPage.getUserGroupName());
