...
//		};
		...
		enabled.setText(Messages.getString("org.nightlabs.jfire.base.admin.timer.TaskDetailSection.enabled.text")); //$NON-NLS-1$
		...
		buildTimePattern.setText(Messages.getString("org.nightlabs.jfire.base.admin.timer.TaskDetailSection.buildTimePattern.text"));		 //$NON-NLS-1$
