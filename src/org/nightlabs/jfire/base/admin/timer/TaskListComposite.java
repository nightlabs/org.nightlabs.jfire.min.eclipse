		...
		extends AbstractTableComposite
{
		...
		public String getColumnText(Object element, int columnIndex)
		{
			...
			case 6:
				if (task.isLastExecFailed() && task.getLastExecMessage() == null)
					return Messages.getString("org.nightlabs.jfire.base.admin.timer.TaskListComposite.TaskListLabelProvider.lastExecFailedWithoutMessage"); //$NON-NLS-1$

				return task.getLastExecMessage() == null ? "" : task //$NON-NLS-1$
						.getLastExecMessage();
			case 7:
				return task.isEnabled() ? Messages.getString("org.nightlabs.jfire.base.admin.timer.TaskListComposite.TaskListLabelProvider.enabled") : Messages.getString("org.nightlabs.jfire.base.admin.timer.TaskListComposite.TaskListLabelProvider.disabled"); //$NON-NLS-1$ //$NON-NLS-2$
			case 8:
				if (task.getNextCalculateNextExecDT() != null)
					return String.format(
							Messages.getString("org.nightlabs.jfire.base.admin.timer.TaskListComposite.TaskListLabelProvider.moreThanCalculateNextExecDTFutureYears"), //$NON-NLS-1$
			...
			case 9:
				if (task.isExecuting())
					return Messages.getString("org.nightlabs.jfire.base.admin.timer.TaskListComposite.TaskListLabelProvider.executing"); //$NON-NLS-1$

				return task.getActiveExecID() == null ? Messages.getString("org.nightlabs.jfire.base.admin.timer.TaskListComposite.TaskListLabelProvider.sleeping") : Messages.getString("org.nightlabs.jfire.base.admin.timer.TaskListComposite.TaskListLabelProvider.queued"); //$NON-NLS-1$ //$NON-NLS-2$
			default:
				return ""; //$NON-NLS-1$
			}
		}
	...
	private NotificationListenerJob taskChangedListener = new NotificationAdapterJob(
			Messages.getString("org.nightlabs.jfire.base.admin.timer.TaskListComposite.taskChangedListener.name")) //$NON-NLS-1$
	{
	...
	protected void createTableColumns(TableViewer tableViewer, Table table)
	{
		...
		col.setText(Messages.getString("org.nightlabs.jfire.base.admin.timer.TaskListComposite.typeTableColumn.text")); //$NON-NLS-1$
		...
		col = new TableColumn(table, SWT.LEFT);
		col.setText(Messages.getString("org.nightlabs.jfire.base.admin.timer.TaskListComposite.userTableColumn.text")); //$NON-NLS-1$
		new TableSortSelectionListener(tableViewer, col,
				new TaskViewerSorter_UserName(), SWT.UP);

		col = new TableColumn(table, SWT.LEFT);
		col.setText(Messages.getString("org.nightlabs.jfire.base.admin.timer.TaskListComposite.nameTableColumn.text")); //$NON-NLS-1$
		new TableSortSelectionListener(tableViewer, col,
				new TaskViewerSorter_TaskName(), SWT.UP);

		col = new TableColumn(table, SWT.LEFT);
		col.setText(Messages.getString("org.nightlabs.jfire.base.admin.timer.TaskListComposite.descriptionTableColumn.text")); //$NON-NLS-1$
		new TableSortSelectionListener(tableViewer, col,
				new TaskViewerSorter_TaskDescription(), SWT.UP);

		col = new TableColumn(table, SWT.RIGHT);
		col.setText(Messages.getString("org.nightlabs.jfire.base.admin.timer.TaskListComposite.lastExecutionTableColumn.text")); //$NON-NLS-1$
		new TableSortSelectionListener(tableViewer, col,
				new TaskViewerSorter_LastExecDT(), SWT.UP);

		col = new TableColumn(table, SWT.RIGHT);
		col.setText(Messages.getString("org.nightlabs.jfire.base.admin.timer.TaskListComposite.durationTableColumn.text")); //$NON-NLS-1$
		new TableSortSelectionListener(tableViewer, col,
				new TaskViewerSorter_Duration(), SWT.UP);

		col = new TableColumn(table, SWT.LEFT);
		col.setText(Messages.getString("org.nightlabs.jfire.base.admin.timer.TaskListComposite.errorMessageTableColumn.text")); //$NON-NLS-1$
		new TableSortSelectionListener(tableViewer, col,
				new TaskViewerSorter_LastExecMessage(), SWT.UP);

		col = new TableColumn(table, SWT.LEFT);
		col.setText(Messages.getString("org.nightlabs.jfire.base.admin.timer.TaskListComposite.enabledTableColumn.text")); //$NON-NLS-1$
		new TableSortSelectionListener(tableViewer, col,
				new TaskViewerSorter_Enabled(), SWT.UP);

		col = new TableColumn(table, SWT.RIGHT);
		col.setText(Messages.getString("org.nightlabs.jfire.base.admin.timer.TaskListComposite.nextExecutionTableColumn.text")); //$NON-NLS-1$
		new TableSortSelectionListener(tableViewer, col,
				new TaskViewerSorter_NextExecDT(), SWT.UP);

		col = new TableColumn(table, SWT.LEFT);
		col.setText(Messages.getString("org.nightlabs.jfire.base.admin.timer.TaskListComposite.statusTableColumn.text")); //$NON-NLS-1$
		new TableSortSelectionListener(tableViewer, col,
	...
	{
		new Job(Messages.getString("org.nightlabs.jfire.base.admin.timer.TaskListComposite.loadTasks.job.taskName")) //$NON-NLS-1$
		{
			@Override
