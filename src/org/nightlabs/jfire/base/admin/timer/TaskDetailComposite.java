...
//		labelDirty.setLayoutData(new GridData(GridData.FILL_HORIZONTAL));
		...
		checkBoxEnabled.setText(Messages.getString("org.nightlabs.jfire.base.admin.timer.TaskDetailComposite.checkBoxEnabled.text")); //$NON-NLS-1$
	...
	{
		currentJob = new Job(Messages.getString("org.nightlabs.jfire.base.admin.timer.TaskDetailComposite.setTaskID.job.name")) { //$NON-NLS-1$
...
//			labelDirty.setText(dirty ? "dirty" : "clean");
	...
	public void submit()
	{
		...
		Job currentJob = new Job(Messages.getString("org.nightlabs.jfire.base.admin.timer.TaskDetailComposite.submit.job.name")) { //$NON-NLS-1$
			protected IStatus run(IProgressMonitor monitor) {
				monitor.beginTask(Messages.getString("org.nightlabs.jfire.base.admin.timer.TaskDetailComposite.submit.monitor.taskName_storing"), 2); //$NON-NLS-1$

				monitor.setTaskName(Messages.getString("org.nightlabs.jfire.base.admin.timer.TaskDetailComposite.submit.monitor.taskName_calculatingNextExecDT")); //$NON-NLS-1$
...
//				task.calculateNextExecDT(); // in case the time pattern has changed
				monitor.worked(1);
				monitor.setTaskName(Messages.getString("org.nightlabs.jfire.base.admin.timer.TaskDetailComposite.submit.monitor.taskName_storingToServer")); //$NON-NLS-1$
