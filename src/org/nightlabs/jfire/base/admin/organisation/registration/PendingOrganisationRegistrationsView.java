...
// TODO these buttons should be view-actions!
  ...
  private RegistrationStatus[] selectedRegistrationStati = null;
	...
	//		TabFolder composite = new TabFolder(parent, SWT.NULL);
			...
			new TableColumn(t, SWT.LEFT).setText(Messages.getString("org.nightlabs.jfire.base.admin.organisation.registration.PendingOrganisationRegistrationsView.organisationIDTableColumn")); //$NON-NLS-1$
			new TableColumn(t, SWT.LEFT).setText(Messages.getString("org.nightlabs.jfire.base.admin.organisation.registration.PendingOrganisationRegistrationsView.directionTableColumn")); //$NON-NLS-1$
			new TableColumn(t, SWT.LEFT).setText(Messages.getString("org.nightlabs.jfire.base.admin.organisation.registration.PendingOrganisationRegistrationsView.statusTableColumn")); //$NON-NLS-1$
			new TableColumn(t, SWT.LEFT).setText(Messages.getString("org.nightlabs.jfire.base.admin.organisation.registration.PendingOrganisationRegistrationsView.openDTTableColumn")); //$NON-NLS-1$
			new TableColumn(t, SWT.LEFT).setText(Messages.getString("org.nightlabs.jfire.base.admin.organisation.registration.PendingOrganisationRegistrationsView.openUserTableColumn")); //$NON-NLS-1$
			new TableColumn(t, SWT.LEFT).setText(Messages.getString("org.nightlabs.jfire.base.admin.organisation.registration.PendingOrganisationRegistrationsView.closeDTTableColumn")); //$NON-NLS-1$
			new TableColumn(t, SWT.LEFT).setText(Messages.getString("org.nightlabs.jfire.base.admin.organisation.registration.PendingOrganisationRegistrationsView.closeUserTableColumn")); //$NON-NLS-1$
