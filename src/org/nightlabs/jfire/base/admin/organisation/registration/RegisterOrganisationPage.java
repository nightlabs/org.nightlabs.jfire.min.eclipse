...
public class RegisterOrganisationPage extends DynamicPathWizardPage
{
	...
	{
		super(RegisterOrganisationPage.class.getName(), Messages.getString("org.nightlabs.jfire.base.admin.organisation.registration.RegisterOrganisationPage.title"), null); //$NON-NLS-1$
	}
	...
	private void createOrganisationTable(Composite parent)
	{
		...
		column.setText(Messages.getString("org.nightlabs.jfire.base.admin.organisation.registration.RegisterOrganisationPage.organisationNameTableColumn.text")); //$NON-NLS-1$
		...
		column.setText(Messages.getString("org.nightlabs.jfire.base.admin.organisation.registration.RegisterOrganisationPage.organisationIDTableColumn.text")); //$NON-NLS-1$
		...
		organisationTable.setInput(new String[] { Messages.getString("org.nightlabs.jfire.base.admin.organisation.registration.RegisterOrganisationPage.organisationTable.input_loading") }); //$NON-NLS-1$
		organisationTable.setSelection(new StructuredSelection(new Organisation[0]));

		new Job(Messages.getString("org.nightlabs.jfire.base.admin.organisation.registration.RegisterOrganisationPage.loadOrganisationsJob.name")) { //$NON-NLS-1$
			@SuppressWarnings("unchecked") //$NON-NLS-1$
	...
	static {
		...
		person.setDisplayName(Messages.getString("org.nightlabs.jfire.base.admin.organisation.registration.RegisterOrganisationPage.manualRegistration")); //$NON-NLS-1$
...
//		page.getGridLayout().verticalSpacing = 9;
		...
		label.setText(Messages.getString("org.nightlabs.jfire.base.admin.organisation.registration.RegisterOrganisationPage.anonymousInitialContextFactoryLabel.text")); //$NON-NLS-1$
		...
		label.setText(Messages.getString("org.nightlabs.jfire.base.admin.organisation.registration.RegisterOrganisationPage.initialContextURL.text")); //$NON-NLS-1$
		...
		label = new Label(compTexts, SWT.NONE);
		label.setText(Messages.getString("org.nightlabs.jfire.base.admin.organisation.registration.RegisterOrganisationPage.organisationIDLabel.text")); //$NON-NLS-1$
