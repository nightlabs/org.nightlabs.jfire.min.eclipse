...
public class CreateWorkstationWizard extends DynamicPathWizard {
	...
	public CreateWorkstationWizard() {
		super();
		setWindowTitle(Messages.getString("org.nightlabs.jfire.base.admin.workstation.CreateWorkstationWizard.wizardTitle")); //$NON-NLS-1$
		createWorkstationPage = new CreateWorkstationPage(Messages.getString("org.nightlabs.jfire.base.admin.workstation.CreateWorkstationWizard.pageTitle")); //$NON-NLS-1$
