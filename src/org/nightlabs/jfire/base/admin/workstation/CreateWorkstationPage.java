...
package org.nightlabs.jfire.base.admin.workstation;
...
public class CreateWorkstationPage extends DynamicPathWizardPage implements FormularChangeListener 
{
	...
	public Control createPageContents(Composite parent) 
	{
		...
		workstationID = f.addTextInput(Messages.getString("org.nightlabs.jfire.base.admin.workstation.CreateWorkstationPage.workstationID.labelText"), null); //$NON-NLS-1$
		workstationDescription = f.addTextInput(Messages.getString("org.nightlabs.jfire.base.admin.workstation.CreateWorkstationPage.description.labelText"), null); //$NON-NLS-1$
		return f;
	}
	...
	protected void verifyInput() 
	{
		if("".equals(getWorkstationID())) //$NON-NLS-1$
			updateStatus(Messages.getString("org.nightlabs.jfire.base.admin.workstation.CreateWorkstationPage.errorWorkstationIDMissing")); //$NON-NLS-1$
		else
			updateStatus(null);
	}
