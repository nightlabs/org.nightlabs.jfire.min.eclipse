 ...
 * 
 */
package org.nightlabs.jfire.base.admin.j2ee;

import org.eclipse.jface.action.Action;
import org.eclipse.swt.SWT;
import org.eclipse.swt.widgets.Composite;
import org.nightlabs.jfire.base.admin.resource.Messages;
import org.nightlabs.jfire.base.j2ee.JMSQueueMessageList;
...
public class JMSQueueMessageListView extends LSDViewPart
{
	...
	private Action autoUpdateAction = new Action(
			Messages.getString("org.nightlabs.jfire.base.admin.j2ee.JMSQueueMessageListView.autoUpdateAction.text_enable") //$NON-NLS-1$
		) {
		@Override
		public void run() {
			...
			if (doAutoUpdate)
				setText(Messages.getString("org.nightlabs.jfire.base.admin.j2ee.JMSQueueMessageListView.autoUpdateAction.text_disable")); //$NON-NLS-1$
			else
				setText(Messages.getString("org.nightlabs.jfire.base.admin.j2ee.JMSQueueMessageListView.autoUpdateAction.text_enable")); //$NON-NLS-1$
