...
import org.nightlabs.jfire.base.admin.configgroup.ConfigGroupMembersEditComposite;
...
extends RestorableSectionPart 
{
	public WorkstationGroupMemberSection(IFormPage page, Composite parent) 
	{
		...
		section.setText(Messages.getString("org.nightlabs.jfire.base.admin.editor.workstationgroup.WorkstationGroupMemberSection.section.text")); //$NON-NLS-1$
		...
		configGroupMembersEditComposite = new ConfigGroupMembersEditComposite(container,
				SWT.NONE, true, this, 
				Messages.getString("org.nightlabs.jfire.base.admin.editor.workstationgroup.WorkstationGroupMemberSection.configGroupMembersEditComposite.available"),  //$NON-NLS-1$
				Messages.getString("org.nightlabs.jfire.base.admin.editor.workstationgroup.WorkstationGroupMemberSection.configGroupMembersEditComposite.selected"));		 //$NON-NLS-1$
	}
