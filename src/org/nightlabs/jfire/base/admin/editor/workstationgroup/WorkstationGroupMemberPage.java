...
extends EntityEditorPageWithProgress 
{
	...
	public WorkstationGroupMemberPage(FormEditor editor) {
		super(editor, WorkstationGroupMemberPage.class.getName(), Messages.getString("org.nightlabs.jfire.base.admin.editor.workstationgroup.WorkstationGroupMemberPage.title")); //$NON-NLS-1$
	}
	...
	protected String getPageFormTitle() {
		return Messages.getString("org.nightlabs.jfire.base.admin.editor.workstationgroup.WorkstationGroupMemberPage.pageFormTitle"); //$NON-NLS-1$
	}
