...
import org.nightlabs.jfire.base.admin.editor.user.ConfigPreferencesController;
import org.nightlabs.jfire.base.admin.editor.user.ConfigPreferencesPage;
import org.nightlabs.jfire.base.admin.editor.user.ConfigPreferencesSection;
...
{	
	...
	public WorkstationFeaturePreferencesTabPage(FormEditor formEditor) {
		super(formEditor, ID_PAGE , Messages.getString("org.nightlabs.jfire.base.admin.editor.workstation.WorkstationFeaturePreferencesTabPage.title")); //$NON-NLS-1$
	}
	...
	protected void createFormContent(IManagedForm managedForm)
	{
		...
		form.setText(Messages.getString("org.nightlabs.jfire.base.admin.editor.workstation.WorkstationFeaturePreferencesTabPage.form.text"));  //$NON-NLS-1$
