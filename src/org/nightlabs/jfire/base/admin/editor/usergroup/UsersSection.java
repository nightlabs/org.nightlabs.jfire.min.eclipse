...
public class UsersSection extends RestorableSectionPart
{
	...
	{
		section.setText(Messages.getString("org.nightlabs.jfire.base.admin.editor.usergroup.UsersSection.sectionTitle")); //$NON-NLS-1$
...
//
	...
	private void createDescriptionControl(Section section, FormToolkit toolkit)
	{
		...
		text.setText(Messages.getString("org.nightlabs.jfire.base.admin.editor.usergroup.UsersSection.description"), false, false); //$NON-NLS-1$
	...
	private void createUserButtons(Composite client, FormToolkit toolkit)
	{
		...
		Button fAddButton = toolkit.createButton(container, Messages.getString("org.nightlabs.jfire.base.admin.editor.usergroup.UsersSection.toRight"), SWT.PUSH); //$NON-NLS-1$
		...
		Button fRemoveButton = toolkit.createButton(container, Messages.getString("org.nightlabs.jfire.base.admin.editor.usergroup.UsersSection.toLeft"), SWT.PUSH); //$NON-NLS-1$
	...
	private Table createUsersTable(FormToolkit toolkit, Composite container)
	{
		...
		col1.setText(Messages.getString("org.nightlabs.jfire.base.admin.editor.usergroup.UsersSection.user")); //$NON-NLS-1$
//		TableColumn col2 = new TableColumn(fTable, SWT.NULL);
//		col2.setText(Messages.getString("org.nightlabs.jfire.base.admin.editor.usergroup.UsersSection.description")); //$NON-NLS-1$
