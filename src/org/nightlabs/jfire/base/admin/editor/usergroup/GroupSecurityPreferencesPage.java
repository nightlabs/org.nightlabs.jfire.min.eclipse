...
import org.nightlabs.jfire.base.admin.editor.user.RoleGroupsSection;
import org.nightlabs.jfire.base.admin.editor.user.SecurityPreferencesController;
...
public class GroupSecurityPreferencesPage extends EntityEditorPageWithProgress
{
	...
	{
		super(editor, ID_PAGE, Messages.getString("org.nightlabs.jfire.base.admin.editor.usergroup.SecurityPreferencesPage.pageTitle")); //$NON-NLS-1$
	}
	...
	protected String getPageFormTitle() {
		return Messages.getString("org.nightlabs.jfire.base.admin.editor.usergroup.SecurityPreferencesPage.pageFormTitle"); //$NON-NLS-1$
	}
}
