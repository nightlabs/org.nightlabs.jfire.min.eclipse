...
public class RoleGroupsSection extends RestorableSectionPart
{
	...
	{
		section.setText(Messages.getString("org.nightlabs.jfire.base.admin.editor.user.RoleGroupsSection.sectionTitle")); //$NON-NLS-1$
	...
	private void createDescriptionControl(Section section, FormToolkit toolkit)
	{
		...
		text.setText(Messages.getString("org.nightlabs.jfire.base.admin.editor.user.RoleGroupsSection.description"), false, false); //$NON-NLS-1$
...
//				ImageDescriptor.createFromURL(BaseAdminPlugin.getDefault().getBundle().getEntry(BaseAdminPlugin.getResourceString("icon.usergroup"))).createImage(); //$NON-NLS-1$
	...
	private Table createRoleGroupsTable(FormToolkit toolkit, Composite container)
	{
		...
		col1.setText(Messages.getString("org.nightlabs.jfire.base.admin.editor.user.RoleGroupsSection.roleGroup")); //$NON-NLS-1$
		TableColumn col2 = new TableColumn(fTable, SWT.NULL);
		col2.setText(Messages.getString("org.nightlabs.jfire.base.admin.editor.user.RoleGroupsSection.description")); //$NON-NLS-1$
	...
	private void createRoleGroupButtons(Composite client, FormToolkit toolkit)
	{
		...
		Button fAddButton = toolkit.createButton(container, Messages.getString("org.nightlabs.jfire.base.admin.editor.user.RoleGroupsSection.toRight"), SWT.PUSH); //$NON-NLS-1$
		...
		Button fRemoveButton = toolkit.createButton(container, Messages.getString("org.nightlabs.jfire.base.admin.editor.user.RoleGroupsSection.toLeft"), SWT.PUSH); //$NON-NLS-1$
