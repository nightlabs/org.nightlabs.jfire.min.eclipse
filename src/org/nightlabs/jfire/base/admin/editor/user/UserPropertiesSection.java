...
import org.nightlabs.jfire.base.prop.edit.blockbased.BlockBasedEditor;
...
public class UserPropertiesSection extends RestorableSectionPart
{
	...
	{
		section.setText(Messages.getString("org.nightlabs.jfire.base.admin.editor.user.UserPropertiesSection.sectionTitle")); //$NON-NLS-1$
