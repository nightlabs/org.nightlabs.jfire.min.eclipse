...
public class UserGroupsSection extends RestorableSectionPart
{
	...
	{
		section.setText(Messages.getString("org.nightlabs.jfire.base.admin.editor.user.UserGroupsSection.sectionTitle")); //$NON-NLS-1$
	...
	private void createDescriptionControl(Section section, FormToolkit toolkit)
	{
		...
		text.setText(Messages.getString("org.nightlabs.jfire.base.admin.editor.user.UserGroupsSection.descriptionText"), true, false); //$NON-NLS-1$
...
//				throw new RuntimeException("Invalid object type, expected UserGroup");
	...
	private Table createUserGroupsTable(FormToolkit toolkit, Composite container)
	{
		...
		col1.setText(Messages.getString("org.nightlabs.jfire.base.admin.editor.user.UserGroupsSection.col0")); //$NON-NLS-1$
		TableColumn col2 = new TableColumn(fTable, SWT.NULL);
		col2.setText(Messages.getString("org.nightlabs.jfire.base.admin.editor.user.UserGroupsSection.col1")); //$NON-NLS-1$
...
//		fTable.setLayout(tlayout);
	...
	private void createUserGroupButtons(Composite client, FormToolkit toolkit)
	{
		...
		Button fAddButton = toolkit.createButton(container, Messages.getString("org.nightlabs.jfire.base.admin.editor.user.UserGroupsSection.toRight"), SWT.PUSH); //$NON-NLS-1$
		...
		Button fRemoveButton = toolkit.createButton(container, Messages.getString("org.nightlabs.jfire.base.admin.editor.user.UserGroupsSection.toLeft"), SWT.PUSH); //$NON-NLS-1$
