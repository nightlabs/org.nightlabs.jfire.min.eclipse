...
public class PersonPreferencesController extends EntityEditorPageController
{
	...
	{
		monitor.beginTask(Messages.getString("org.nightlabs.jfire.base.admin.editor.user.PersonPreferencesController.loadingUserPerson"), 4); //$NON-NLS-1$
		try {
//			Thread.sleep(1000);
			if(userID != null) {
	...
	public void doSave(IProgressMonitor monitor)
	{
		...
		monitor.beginTask(Messages.getString("org.nightlabs.jfire.base.admin.editor.user.PersonPreferencesController.doSave.monitor.taskName"), 6); //$NON-NLS-1$
		try	{
			monitor.worked(1);
