...
import org.nightlabs.jfire.base.prop.edit.blockbased.BlockBasedEditorSection;
...
public class PersonPreferencesPage extends EntityEditorPageWithProgress
{
	...
	{
		super(editor, ID_PAGE, Messages.getString("org.nightlabs.jfire.base.admin.editor.user.PersonPreferencesPage.pageTitle")); //$NON-NLS-1$
	}

	@Override
	protected void addSections(Composite parent) {
		userPropertiesSection = new BlockBasedEditorSection(this, parent, Messages.getString("org.nightlabs.jfire.base.admin.editor.user.PersonPreferencesPage.sectionTitle")); //$NON-NLS-1$
	...
	protected String getPageFormTitle() {
		return Messages.getString("org.nightlabs.jfire.base.admin.editor.user.PersonPreferencesPage.pageFormTitle"); //$NON-NLS-1$
	}
}
