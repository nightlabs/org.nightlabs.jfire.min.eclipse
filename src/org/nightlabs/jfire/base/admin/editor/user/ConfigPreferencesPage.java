...
public class ConfigPreferencesPage extends FormPage
{
	...
	{
		super(editor, ID_PAGE, Messages.getString("org.nightlabs.jfire.base.admin.editor.user.ConfigPreferencesPage.pageTitle")); //$NON-NLS-1$
	}
	...
	protected void createFormContent(IManagedForm managedForm)
	{
		...
		form.setText(Messages.getString("org.nightlabs.jfire.base.admin.editor.user.ConfigPreferencesPage.formTitle"));  //$NON-NLS-1$
