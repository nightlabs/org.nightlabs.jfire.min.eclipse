...
extends RestorableSectionPart 
{
	public UserConfigGroupMemberSection(IFormPage page, Composite parent) {
		...
		section.setText(Messages.getString("org.nightlabs.jfire.base.admin.editor.userconfiggroup.UserConfigGroupMemberSection.section.text")); //$NON-NLS-1$
		...
		configGroupMembersEditComposite = new ConfigGroupMembersEditComposite(container,
				SWT.NONE, true, this, 
				Messages.getString("org.nightlabs.jfire.base.admin.editor.userconfiggroup.UserConfigGroupMemberSection.configGroupMembersEditComposite.available"),  //$NON-NLS-1$
				Messages.getString("org.nightlabs.jfire.base.admin.editor.userconfiggroup.UserConfigGroupMemberSection.configGroupMembersEditComposite.selected")); //$NON-NLS-1$
	}
