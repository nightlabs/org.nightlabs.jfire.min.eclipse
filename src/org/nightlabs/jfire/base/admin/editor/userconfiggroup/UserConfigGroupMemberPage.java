...
extends EntityEditorPageWithProgress 
{
	...
	public UserConfigGroupMemberPage(FormEditor editor) {
		super(editor, UserConfigGroupMemberPage.class.getName(), Messages.getString("org.nightlabs.jfire.base.admin.editor.userconfiggroup.UserConfigGroupMemberPage.title")); //$NON-NLS-1$
	}
	...
	protected String getPageFormTitle() {
		return Messages.getString("org.nightlabs.jfire.base.admin.editor.userconfiggroup.UserConfigGroupMemberPage.pageFormTitle"); //$NON-NLS-1$
	}
