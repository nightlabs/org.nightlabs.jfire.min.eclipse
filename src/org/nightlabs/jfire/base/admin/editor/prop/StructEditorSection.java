...
import org.nightlabs.jfire.base.prop.structedit.action.AddStructBlockAction;
import org.nightlabs.jfire.base.prop.structedit.action.AddStructFieldAction;
import org.nightlabs.jfire.base.prop.structedit.action.MoveStructElementAction;
import org.nightlabs.jfire.base.prop.structedit.action.RemoveStructElementAction;
...
implements StructureChangedListener
{
	public StructEditorSection(IFormPage page, Composite parent) 
	{
		super(page, parent, ExpandableComposite.TITLE_BAR | ExpandableComposite.TWISTIE,
					Messages.getString("org.nightlabs.jfire.base.admin.editor.prop.StructEditorSection.title")); //$NON-NLS-1$
