						...
						Display.getCurrent().asyncExec(new Runnable() {
							...
							public void run() {
								...
								if (clientScriptNames.contains(newScriptName)) {
									setErrorMessage(Messages.getString("org.nightlabs.jfire.base.dashboard.ui.internal.clientScripts.DashboardGadgetClientScriptsNewEditDialog.createDialogArea.errorMessage.scriptExists")); //$NON-NLS-1$
									getButton(IDialogConstants.OK_ID).setEnabled(false);
								} else if (newScriptName.equals("")) { //$NON-NLS-1$
									setErrorMessage(Messages.getString("org.nightlabs.jfire.base.dashboard.ui.internal.clientScripts.DashboardGadgetClientScriptsNewEditDialog.createDialogArea.errorMessage.emptyName")); //$NON-NLS-1$
									getButton(IDialogConstants.OK_ID).setEnabled(false);
								} else {
