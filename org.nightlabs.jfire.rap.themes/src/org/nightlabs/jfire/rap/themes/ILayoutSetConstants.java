 ...
 ******************************************************************************/
package org.nightlabs.jfire.rap.themes;
...
public interface ILayoutSetConstants {
  ...
  public static final String SET_ID_CONFIG_DIALOG 
    = "org.nightlabs.jfire.rap.themes.layoutset.confdialog";    //$NON-NLS-1$
  public static final String SET_ID_COOLBAR 
    = "org.nightlabs.jfire.rap.themes.layoutset.coolbar";   //$NON-NLS-1$
  public static final String SET_ID_OVERFLOW 
  = "org.nightlabs.jfire.rap.themes.layoutset.coolbaroverflow"; //$NON-NLS-1$
  public static final String SET_ID_FOOTER 
    = "org.nightlabs.jfire.rap.themes.layoutset.footer";  //$NON-NLS-1$
  public static final String SET_ID_HEADER 
    = "org.nightlabs.jfire.rap.themes.layoutset.header";  //$NON-NLS-1$
  public static final String SET_ID_LOGO 
    = "org.nightlabs.jfire.rap.themes.layoutset.logo"; //$NON-NLS-1$
  public static final String SET_ID_MENUBAR 
    = "org.nightlabs.jfire.rap.themes.layoutset.menubar"; //$NON-NLS-1$
  public static final String SET_ID_PERSP 
    = "org.nightlabs.jfire.rap.themes.layoutset.perspective"; //$NON-NLS-1$
  public static final String SET_ID_STACKPRESENTATION 
    = "org.nightlabs.jfire.rap.themes.layoutset.stack";   //$NON-NLS-1$
