...
//				propertySet.getStructLinkClass(), propertySet.getStructScope(), propertySet.getStructLocalScope(),
	...
	public void updatePropertySet() {
		...
		// We don't show a display-name UI, however we still update the display-name, it might be affected by the fields  
		if (propertySet != null && propertySet.isAutoGenerateDisplayName()) {
