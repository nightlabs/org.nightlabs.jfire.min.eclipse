...
public class PropertySetFieldBasedEditLayoutPreferenceLoginStateListener implements
	...
	public void loginStateChanged(LoginStateChangeEvent event) {
		if (event.getNewLoginState() == LoginState.LOGGED_IN) {
			PlatformUI.getWorkbench().getPreferenceManager().addTo("org.nightlabs.base.ui.preference.UIPreferencePage", new PropertySetFieldBasedEditLayoutPreferenceRootNode(PropertySetFieldBasedEditLayoutPreferenceRootNode.class.getName())); //$NON-NLS-1$
